...
import os
import traceback
from JackCompiler_dir import JackCompiler as Compiler
from JackCompiler_dir.SyntaxAnalyzer import Analyzer as Analyzer
FILE_PATH = 1
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        print("Error: Wrong number of arguments.\n"
              "Usage: JackCompiler_dir file_name.jack or /existing_dir_path/")
    else:
